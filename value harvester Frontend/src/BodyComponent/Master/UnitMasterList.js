...
const UnitMasterList = () => {
    ...
    const [searchParam] = useState(["unit"]);
    ...
    const deleteRecord = () => {
        axios.put("http://localhost:5050/api/unit_delete", { _id: deleteInfo._id })
            .then(res => {
                getData();
                setIsDelete(false);
            }).catch(err => {
...
>
                        ...
                        <Grid item md={12}>
                            <Link to="/unitMaster/unitMasterEntry" style={{ textDecoration: 'unset' }}>
            ...
            <Paper style={{ marginTop: '20px', height: 'auto', padding: '25px', margin: '30px' }}>
                ...
                <TableContainer component={Paper}>
                    <Table sx={{ minWidth: 700 }} aria-label="customized table">
                        ...
                        {/* <TableBody style={{background:'#a5d6a7'}}> */}
                        <TableBody>
                            {/* {rows
                                .map((row, index) => (  */}
                            {search(rows)
                                ...
                                .map((row, index) => (
                                    <StyledTableRow >
                                        ...
                                        <StyledTableCell align="center">
                                            <Link to={{ pathname: `./unitMasterEntry`, search: "edit" }} state={row}>
            ...
            <Dialog open={isDelete}>
                <DialogTitle style={{ color: 'red' }}>Are you sure you want to delete #{deleteInfo && deleteInfo.unitName} record?</DialogTitle>
                <DialogActions>
